    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.BTNcarolina:
                ...
                Response.Listener<String> responListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success) {
                                Intent intent = new Intent(Presidenciales.this, Registro.class);
                                Presidenciales.this.startActivity(intent);
                            } else {
                                AlertDialog.Builder builder = new AlertDialog.Builder(Presidenciales.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNguller:
                ...
                RequestQueue queu = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNpiñera:
                ...
                RequestQueue queue1 = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNartes:
                ...
                RequestQueue queue1Queue2 = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNsanchez:
                ...
                RequestQueue queue5 = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNmeo:
                ...
                RequestQueue queue6 = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNkast:
                ...
                RequestQueue queue7 = Volley.newRequestQueue(Presidenciales.this);
            ...
            case R.id.BTNnavarro:
                ...
                RequestQueue queue8 = Volley.newRequestQueue(Presidenciales.this);
